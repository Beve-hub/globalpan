...
const Referrals = () => {
  ...
  const [referralLink, setReferralLink] = useState<string>(''); // Set referralLink as a state
      ...
      if (userId) {
        ...
        if (snapshot.exists()) {
          ...
          if (userDetails) {
            ...
            setName(userName);
            setReferralLink(`https://nexcelglobal.com/referral/${userName}`); // Update referralLink
  ...
  return (
    <Box style={{ backgroundColor: Color.INFO_COLOR, padding: '1rem', borderRadius: 10, width: '100%' }}>
      ...
      <div style={{
        ...
        <TextInput
          value={referralLink} // Updated to use the dynamic referralLink
          readOnly
          rightSection={
